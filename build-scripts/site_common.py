...
@media(max-width:900px){.snap-row{display:grid;grid-template-columns:1fr;max-width:440px;margin:0 auto;overflow-x:visible;scroll-snap-type:none;width:auto;position:static;left:auto;padding:0}}
