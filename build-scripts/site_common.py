...
@media(max-width:900px){
 ...
 .snap-row{display:grid;grid-template-columns:1fr;max-width:440px;margin:0 auto;overflow-x:visible;scroll-snap-type:none}
...
.snap-row{display:flex;gap:16px;overflow-x:auto;scroll-snap-type:x mandatory;padding-bottom:10px;-webkit-overflow-scrolling:touch}
.snap-row .card{scroll-snap-align:start;flex:0 0 220px;min-width:220px;background:var(--panel);border-radius:12px;overflow:hidden;border:1px solid rgba(255,255,255,.08)}
